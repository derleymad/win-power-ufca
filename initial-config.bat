...
FOR %%A IN (microsoft-office-deployment adobereader googlechrome firefox jre8 vlc winrar 7zip teamviewer google-drive-file-stream qbittorrent) DO CHOCO INSTALL %%A -Y
...
ECHO ------------------------ DESATIVANDO NVIDIA Telemetry ------------------------ 

SCHTASKS /Change /TN "\NvTmMon_{B2FE1952-0186-46C3-BAEC-A80AA35AC5B8}" /Disable 
SCHTASKS /Change /TN "\NvTmRep_{B2FE1952-0186-46C3-BAEC-A80AA35AC5B8}" /Disable
SCHTASKS /Change /TN "\NvTmRepOnLogon_{B2FE1952-0186-46C3-BAEC-A80AA35AC5B8}" /Disable

ECHO ------------------------ CONFIGURANDO PRIVACIDADE ------------------------ 
...
ECHO ------------------------ DESATIVANDO ASSITENCIA REMOTA NATIVA ------------------------ 
...
ECHO ------------------------ REMOVENDO TELEMETRY E DATA COLLECTION E DESATIVANDO CORTANA ------------------------ 
...
ECHO ------------------------ DESATIVANDO PRE-RELEASE FEATURES OR SETTINGS ------------------------ 
...
ECHO ------------------------  DESATIVANDO TELEMETRIA DO OFFICE ------------------------ 
...
ECHO ------------------------  DESATIVANDO TELEMETRIA DO SKYPE ------------------------ 
...
ECHO ------------------------ DESATIVANDO OUTRAS COISAS DESNECESSARIAS ------------------------ 
...
ECHO ------------------------ DELETANDO OUTROS APLICATIVOS DESNECESSARIOS ------------------------ 
...
ECHO ------------------------ REMOVENDO PASTAS MEU COMPUTADOR ------------------------

ECHO ------------------------  REMOVENDO 3D OBJETOS ------------------------ 
...
ECHO ------------------------  REMOVENDO CameraRollLibrary ------------------------ 
...
ECHO ------------------------ DESATIVANDO MyComputer menu Music ------------------------ 
...
ECHO ------------------------ DESATIVANDO DO MEU COMPUTADOR A POASTA PICTURES ------------------------ 
...
ECHO ------------------------ ADICIONADO "Take Ownership" NO MENU ------------------------ 
...
ECHO ------------------------ CONFIGURACOES Underline keyboard shortcuts and access keys ------------------------ 

REG ADD "HKCU\Control Panel\Accessibility\Keyboard Preference" /v "On" /t REG_SZ /d 1 /f

ECHO ------------------------ COMEANDO PELO WINDOWS EXPLORER INVEZ DO QUICKACESS ------------------------ 
...
ECHO ------------------------ DESATIVANDO LISTA MRU (jump lists) DOS APLICATIVOS XAML NO MENU INICIAL ------------------------ 
...
ECHO ------------------------  USAR PHOTO VIEWER PARA ABRIR FOTOS COMO PADRAO ------------------------ 
...
ECHO ------------------------ DESATIVANDO PROTOCOLO SMB ------------------------ 
...
ECHO ------------------------ LIMPANDO CACHE E ARQUIVOS LIXO ------------------------
...
ECHO ------------------------ LIMPAR AUTOSTART REGISTRY ------------------------ 
...
ECHO ------------------------ TODOS OS UPDATES SERAO PERMANENTEMENTE APAGADOS ------------------------ 
...
ECHO ------------------------  BLOQUEANDO PORTAS DESNECESSARIAS ABERTAS ------------------------ 
